...
% Bei unserem Projekt ging es darum Twitter-Daten raumzeitlich zu Analysieren um Naturkatastrophen zu Erkennen und Analysieren zu können.
% Dafür benötigt man einen ClusteringAlgorithmus und unsere Aufgabe bestand in der Implementierung eines solchen Algorithmus und eines Frameworks zum Testen
% Unser Betreuer beim DLR hat uns dafür ein Paper bereitgestellt, das den FDCA beschreibt.
...
%	\end{frame}
	...
	\begin{frame}{Wesentliche Leistungen}{}
		\begin{itemize}
			\item Implementierung % Implementierung eines Clustering Algorithmus auf Grundlage des FDCA
			\item Fehler aus dem Paper aufgelöst % Im Paper nicht genau oder falsch beschriebene Teile des Algorithmus wurden selbst ausgearbeitet
			\item Vorbereitung der Daten
			\item Entwicklung geeigneter Darstellungsformen
			\item Einbindung in Commandline-Programm
		\end{itemize}		% Für die genannten Punkte haben wir ca. 12-15h pro Woche investiert
	\end{frame}
